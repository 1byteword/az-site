...
const AmericanFlag = () => (
  ...
  >
    ...
    <path
      d="M0,3.5h50m0,5H0m0,5h50m0,5H0m0,5h50m0,5H0"
      stroke="#fff"
      strokeWidth="2"
    />
...
const BlogPostsSection = () => {
  ...
  return (
    <section
      className={`${crimsonPro.className} h-screen w-full relative snap-start bg-[#0f271f] overflow-hidden`}
    >
...
const EtherealEthosSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`${crimsonPro.className} h-screen w-full relative snap-start overflow-hidden bg-[#f5e6d3]`}
    >
      ...
      <div className="relative z-10 h-full flex">
        ...
        <div className="w-1/2 pr-16 pl-8 flex items-center">
          <p className="text-xl text-[#4a2511] leading-relaxed">
            I am currently a Data Engineer at Rivian, where I build software
            tools to help the company understand and improve their vehicle
            fleets. I get to wear many hats; designing and building data
            pipelines, chaos engineering, systems engineering, hacking on
            observability tools, and more.
          </p>
        </div>
      </div>
    </section>
...
const YeOldeRenaissanceWebsite = () => {
  return (
    <div
      className={`${crimsonPro.className} h-screen w-full overflow-y-scroll snap-y snap-mandatory`}
    >
      <section className="h-screen w-full bg-[url('/schoolofathens.jpg')] bg-cover bg-center relative snap-start">
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-8 text-parchment">
          <header className="flex justify-between items-center">
            <AmericanFlag />
            <button className="px-4 py-2 bg-brown-600 text-parchment rounded-sm text-sm">
              Contact
            </button>
          </header>
          <main className="flex-grow flex flex-col justify-end">
            ...
            <p className="text-2xl mb-4">
              Software and Data Engineering, Distributed Systems, AI/ML
            </p>
            <button className="px-6 py-3 bg-parchment/20 text-parchment rounded-sm w-max">
              Learn More
            </button>
          </main>
        </div>
